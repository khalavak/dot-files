...
--beautiful.init(awful.util.getdir("config") .. "/themes/blackcat/theme.lua")
...
for s = 1, screen.count() do
    ...
    mywibox[s].widgets = {
        ...
        mylayoutbox[s],
        mytextclock,
        batwidget, baticon or nil,
 	    memtext, membar.widget, memicon or nil,               
        cpugraph.widget, cpuwidget, cpuicon or nil,
